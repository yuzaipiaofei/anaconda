...
class WelcomeWindow:
    def __call__(self, screen):
        rc = ButtonChoiceWindow(screen, _("Red Hat High Availability Server"), 
                                _("Welcome to Red Hat High Availability Server!\n\n"
                                  "This installation process is outlined in detail in the "
                                  "Installation Guide.  If you have access to this manual, you "
                                  "should read the installation section before continuing.\n\n"
                                  "Be sure to register your purchase of Red Hat High Availability "
                                  "server through our web site, http://www.redhat.com/."),
